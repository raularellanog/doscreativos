...
<body>
    ...
    <header id="header">
        <div class="container">
            ...
            <h1>
                <a href="index.html">
                    <img src="/assets/img/Logo-blanco-sin-bordes.png" alt="">
                </a>
            </h1>
            <!-- Uncomment below if you prefer to use an image logo -->
            <!-- <a href="index.html" class="mr-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a> -->
            <h2 style="size: 4em !important">Creamos<span> </span> <span id="myElement"></span></h2>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="resume-item pb-0">
                        <h4>Alice Barkley</h4>
                        <p><em>Innovative and deadline-drivenDos creativos with 3+ years of experience designing and
    ...
    <div class="credits">
        Designed by <a href="#">Dos creativos</a>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var typed = new Typed('#myElement', {
                strings: ['diseños extraordinaria', 'marcas únicas', 'estrategias digitales innovadoras',
                    ''
                ],
                typeSpeed: 100,
                loop: true
